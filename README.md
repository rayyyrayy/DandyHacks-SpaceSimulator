./space_re:ACT is an interactive game that tests a player's ability to react to verbal and visual instructions in a high-pressure, simulated space cockpit environment. The player must successfully push buttons and pull levers to manage a space mission before disaster strikes. This short interactive story simulates the intense pressure and efficiency required for an astronaut's job. 
